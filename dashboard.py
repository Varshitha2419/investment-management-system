...
class IMS:
    def __init__(self, root):
        ...
        #------------- title --------------
        self.icon_title = PhotoImage(file=os.path.join(BASE_DIR, "images", "logo1.png"))
        ...
        #---------------- left menu ---------------
        self.MenuLogo = Image.open(os.path.join(BASE_DIR, "images", "menu_im.png"))
        ...
        self.icon_side = PhotoImage(file=os.path.join(BASE_DIR, "images", "side.png"))
        ...
        btn_category = Button(LeftMenu, text="Category", command=self.category, image=self.icon_side,
                              compound=LEFT, padx=5, anchor="w", font=("times new roman", 20, "bold"),
                              bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        btn_product = Button(LeftMenu, text="Products", command=self.product, image=self.icon_side,
                             compound=LEFT, padx=5, anchor="w", font=("times new roman", 20, "bold"),
                             bg="white", bd=3, cursor="hand2").pack(side=TOP, fill=X)
        ...
        # ✅ Exit button fixed (font same as others)
        btn_exit = Button(LeftMenu, text="Exit", command=self.root.destroy,
        ...
        self.lbl_supplier=Button(self.root,text="Total Supplier\n[ 0 ]",
                                 bd=5,relief=RIDGE,bg="#ff5722",fg="white",
                                 font=("goudy old style",20,"bold"),
    ...
    def update_content(self):
        ...
        try:
            ...
            bill = len(os.listdir(os.path.join(BASE_DIR, "bill")))
